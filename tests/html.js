...
function inline_element_with_text_retains_spacing() {
    ...
    if (assertions)
        return assertions;
    let templateLiteral = hcs.inline_element_with_text_retains_spacing_literal();
    let resultsLiteral = html.render(templateLiteral);
    return assert(expected, resultsLiteral);
}
...
function text_with_inline_elements_retain_spacing() {
    ...
    if (assertions)
        return assertions;
    let templateLiteral = hcs.text_with_inline_elements_retain_spacing_literal();
    let resultsLiteral = html.render(templateLiteral);
    return assert(expected, resultsLiteral);
}
...
function void_elements_can_have_attributes() {
    let expected = '<!DOCTYPE html><input type=checkbox> <input woof="bark">\n<input grrr><input>';
...
function nested_void_element_with_siblings_retains_spacing() {
    ...
    if (assertions)
        return assertions;
    let templateLiteral = hcs.nested_void_element_with_siblings_retains_spacing_literal();
    let resultsLiteral = html.render(templateLiteral);
    return assert(expected, resultsLiteral);
}
